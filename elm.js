...
var $author$project$Main$bubbleSortStep = F2(
	...
	function (_v0, model) {
		if (model.sorted) {
			...
			var nextIndex = (_Utils_cmp(
				model.index,
				$elm$core$Array$length(model.array) - 2) > -1) ? 0 : (model.index + 1);
			var _v1 = A2($author$project$Main$bubbleSortStep, model.array, model.index);
			var newArray = _v1.a;
			var swapOccurred = _v1.b;
			var isSorted = (_Utils_cmp(
				model.index,
				$elm$core$Array$length(model.array) - 2) > -1) ? (!(model.didSwap || swapOccurred)) : false;
			var resetDidSwap = (_Utils_cmp(
				model.index,
				$elm$core$Array$length(model.array) - 2) > -1) ? false : (model.didSwap || swapOccurred);
		...
		_List_fromArray(
			[
					...
					[
						...
						'Array: ' + A2(
							...
							A2(
								...
								$elm$core$Array$toList(model.array))))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Index: ' + $elm$core$String$fromInt(model.index))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Sorted: ' + $author$project$Main$stringFromBool(model.sorted))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Did Swap: ' + $author$project$Main$stringFromBool(model.didSwap))
					])),
				A2(
